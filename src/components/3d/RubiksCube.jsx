    ...
    for (let y = -1; y <= 1; y++) {
      for (let z = -1; z <= 1; z++) {
        cubies.push({
          pos: [x, y, z],
          colors: [
            x === 1 ? FACE_COLORS.R : INNER,   // Right
            x === -1 ? FACE_COLORS.L : INNER,  // Left
            y === 1 ? FACE_COLORS.U : INNER,   // Up
            y === -1 ? FACE_COLORS.D : INNER,  // Down
            z === 1 ? FACE_COLORS.F : INNER,   // Front
            z === -1 ? FACE_COLORS.B : INNER,  // Back
          ],
        })
      }
    }
